...
public class Vuelto {
   ...
   Vuelto(int cantidad, int[] monedas) {
   ...
   public static void main(String[] args) {
      int[] vector = { 1, 2, 5, 10, 20, 50, 100, 500 };
      Vuelto b = new Vuelto(1250, vector);
      int[] vuelto = b.getVectorSeleccion();
      for (int temp : vuelto)
